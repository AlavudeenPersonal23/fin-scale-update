...
@section('header')
    <div class="back-arrow"> 
        <a href="{{url('/sheds')}}"> <img src="{{asset('img/svg/arrow.svg')}}" alt="back-arrow" /> Create Route</a>
    </div>
@endsection
@section('content')
<form class="needs-validation" method="POST" action="{{ route('shed-save') }}">
  @csrf
    <div class="min-hight-600">
        <div class="form-row">
            <div class="col-md-12 mb-3">
                <label for="validationCustom01">Route Name</label>
                <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Route Name" name="name" required>
                @error('name')
