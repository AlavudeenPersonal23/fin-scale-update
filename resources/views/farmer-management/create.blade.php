...
@section('header')
    <div class="back-arrow"> 
        <a href="{{url('/farmers')}}"> <img src="{{asset('img/svg/arrow.svg')}}" alt="back-arrow" /> Create Employee</a>
    </div>
@endsection
@section('content')
<form class="needs-validation" method="POST" action="{{ route('farmer-save') }}">
  @csrf
    <div class="min-hight-600">
        <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Employee Name" name="name" required>
                @error('name')
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" class="form-control @error('member_id') is-invalid @enderror" placeholder="Enter Employee ID" name="member_id" required>
                @error('name')
                  <div class="invalid-feedback">
