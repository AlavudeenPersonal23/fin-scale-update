...
@endsection
@section('content')
<form class="needs-validation" method="POST" action="{{ route('get-new-report-two') }}">
	@csrf
        ...
        <div class="form-row">
			...
			<div class="table-responsive-sm" id="tab">
				...
				@if(count($report_data) > 0)
					<tr>
						<th class="p-2" scope="col">S.No</th>
						<th class="p-2" scope="col">Member No</th>
						<th class="p-2" scope="col">Party Name</th>
						<th class="p-2" scope="col">GL Receipt No</th>
						<th class="p-2" scope="col">No of Bags</th>
						<th class="p-2" scope="col">Gross</th>
						@foreach($wastes as $waste)
							<th class="p-2" scope="col">{{$waste->name}}</th>
						@endforeach
						<th class="p-2" scope="col">Net Kgs</th>
					</tr>
