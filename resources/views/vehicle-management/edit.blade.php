...
@section('header')
    <div class="back-arrow"> 
        <a href="{{url('/vehicles')}}"> <img src="{{asset('img/svg/arrow.svg')}}" alt="back-arrow" /> Edit Vehicle</a>
    </div>
@endsection
@section('content')
<form class="needs-validation" method="POST" action="{{ route('vehicle-update') }}">
  @csrf
    ...
    <div class="min-hight-600">
        <div class="form-row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Vehicle Number" name="name" required value="{{$vehicle->name}}">
                @error('name')
