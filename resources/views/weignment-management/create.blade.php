...
@section('header')
    <div class="back-arrow"> 
        <a href="{{url('/weignments')}}"> <img src="{{asset('img/svg/arrow.svg')}}" alt="back-arrow" /> Create Weighment</a>
    </div>
@endsection
@section('content')
<form class="needs-validation" method="POST" action="{{ route('weignment-save') }}">
  @csrf
	<div class="empty">
		<div class="tab-list">
			<ul >
		...
		<div id="basic-detail">
			<div class="form-row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-12 ">
					...
					<input type="datetime-local" class="form-control" placeholder="Enter Weighment Date" name="weignment_date">
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-12 ">
					<div class="form-group">
		...
		<div id="weighment-detail" style="overflow:scroll">
			<div class="form-row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
					...
					<input type="text" class="form-control" placeholder="Enter Gross Weight" name="gross_weight" id="gross_weight" onchange="calculateWeight()">
				...
				<div class="form-row">
					<div class="col-lg-12" id="weighment-grade">
						<div class="row" id="weighment-grade0">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 col-12 ">
								<label>Value</label>
								<input type="number" id="grade-value0" class="form-control grade-value" placeholder="Enter Grade Value" name="grade_weight[0]" step="any" onchange="calculateGrade()">
							</div>
						</div>
